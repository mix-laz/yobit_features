...
class _ChatNotificationsState extends State<ChatNotifications> {
  ...
  void trackingNickInPlatform(String nick) async {
    var methodChannel = MethodChannel("com.yobit_features.messages");
    List<dynamic> dynam =
        await methodChannel.invokeMethod("trackingNick", {"nick": nick});
  ...
  void removeNickInPlatform(String name) async {
    ...
    var methodChannel = MethodChannel("com.yobit_features.messages");
    List<dynamic> dynam =
        await methodChannel.invokeMethod("removeNick", {"name": name});
    List<String> result = dynam.cast<String>();
    setState(() {
      _list = result;
    });
